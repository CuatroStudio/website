		...
		<main className="site-home">
			<section className="studio-hero">
				<div className="studio-hero-copy">
					<h1>Apps that feel at home on your Mac</h1>
					<h2>Carefully crafted tools with a focus on clarity, speed, and native macOS design. A collection of independent apps shaped by native design, smooth interactions, and thoughtful UX.</h2>
				</div>
			</section>
			<section className="product-showcase product-card-list" aria-label="Products">
				<div
